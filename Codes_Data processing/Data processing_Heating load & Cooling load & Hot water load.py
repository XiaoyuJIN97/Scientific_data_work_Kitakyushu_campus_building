...
# 指定包含XLSX文件的文件夹路径
folder_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Energy station\2012\39"

# 创建一个ExcelWriter对象，用于写入XLSX文件
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Heating load & Cooling load & Hot water load\2012.xlsx"
