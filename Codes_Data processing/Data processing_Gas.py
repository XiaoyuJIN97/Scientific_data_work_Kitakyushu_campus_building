...
# 指定包含XLSX文件的文件夹路径
folder_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Energy station\2022\Buildings electricity usage"

# 创建一个ExcelWriter对象，用于写入XLSX文件
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Gas\Gas usage_2022.xlsx"
...
conditions = {
    ...
    '50511': 'Fuel cell',
    '50505': 'Gas engine',
    '51101': 'Absorption chiller 1',
    '51102': 'Absorption chiller 2',
    '51103': 'Absorption chiller 3'
}
