...
# 指定包含XLSX文件的文件夹路径
folder_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Energy station\2002\Buildings electricity usage"

# 创建一个ExcelWriter对象，用于写入XLSX文件
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Energy station\2002\Buildings electricity usage\Buildings electricity usage_2002.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '10008': 'Research building',
    '20005': 'Experimental building',
    '60006': 'Industry and Education Building',
    '70009': 'Communication building',
    '80007': 'GYM',
    '90004': 'Media building'
}
