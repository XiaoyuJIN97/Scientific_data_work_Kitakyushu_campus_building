...
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Media building\2022.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '90505': 'Supply water temperature',
    '90506': 'Return water temperature',
    '90504': 'Water flow',
    '90501': 'Total heating quantity',
    '90519': 'Cooling quantity',
    '90518': 'Heating quantity'
}
