...
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Measurement building\2022.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '110116': 'Supply water temperature',
    '110117': 'Return water temperature',
    '110115': 'Water flow',
    '110118': 'Total heating quantity',
    '110112': 'Cooling quantity',
    '110113': 'Heating quantity'
}
