...
# 读取Excel文件# 读取Excel文件
file_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Heat recovery\Heat recovery_2022.xlsx"  # 请将文件路径更新为实际路径
...
# 保存处理后的数据为Excel文件
processed_df.to_excel(r'E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Heat recovery\Heat recovery__time series_2022.xlsx', index=False)
