...
# 指定包含XLSX文件的文件夹路径
folder_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Raw data\2002"

# 创建一个ExcelWriter对象，用于写入XLSX文件
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Research building\2002.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '10605': 'Supply water temperature',
    '10606': 'Return water temperature',
    '10604': 'Water flow',
    '10601': 'Total heating quantity',
    '10611': 'Cooling quantity',
    '10612': 'Heating quantity'
}
