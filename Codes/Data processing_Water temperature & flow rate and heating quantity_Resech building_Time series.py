...
# 读取Excel文件# 读取Excel文件
file_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Research building\2014.xlsx"  # 请将文件路径更新为实际路径
...
# 创建包含日期和时间的列名
dates = pd.date_range(start="2014-01-01", periods=365)
...
# 保存处理后的数据为Excel文件
processed_df.to_excel(r'E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Research building\Time series_2014.xlsx', index=False)
