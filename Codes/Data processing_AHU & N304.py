...
# 指定包含XLSX文件的文件夹路径
folder_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Energy station\2001\38"

# 创建一个ExcelWriter对象，用于写入XLSX文件
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\AHU & N304\AHU & N304_2001.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '11308': 'N304',
    '10902': 'Air supply temperature',
    '10905': 'Temperature below the corridor',
    '10904': 'Humidity below the corridor',
    '10906': 'Outdoor air intake temperature'
}
