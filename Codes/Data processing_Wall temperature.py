...
# 指定包含XLSX文件的文件夹路径
folder_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Energy station\2022\38"


# 创建一个ExcelWriter对象，用于写入XLSX文件
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\AHU & N304\Wall temperature_2022.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '110723': '2F North room temperature (℃)',
    '110724': '2F North wall temperature (℃)',
    '110725': '2F South room temperature (℃)',
    '110726': '2F South wall temperature (℃)'
}
