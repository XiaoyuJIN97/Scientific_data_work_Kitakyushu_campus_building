...
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Experimental building\2022.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '20516': 'Supply water temperature',
    '20517': 'Return water temperature',
    '20515': 'Water flow',
    '20512': 'Total heating quantity',
    '20525': 'Cooling quantity',
    '20524': 'Heating quantity'
}
