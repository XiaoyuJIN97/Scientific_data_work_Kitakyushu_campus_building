...
# 指定包含XLSX文件的文件夹路径
folder_path = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Raw data\2014"

# 创建一个ExcelWriter对象，用于写入XLSX文件
output_file = r"E:\Scientific_data_work_Kitakyushu_campus_building\Data Processing\Water temperature & flow rate and heating quantity\Communication building\2014.xlsx"
writer = pd.ExcelWriter(output_file, engine='xlsxwriter')

# 定义要筛选的条件和对应的sheet名称
conditions = {
    '80417': 'Supply water temperature',
    '80418': 'Return water temperature',
    '80416': 'Water flow',
    '80420': 'Total heating quantity',
    '80411': 'Cooling quantity',
    '80412': 'Heating quantity'
}
